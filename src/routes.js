...
const routes = [
  ...
  { path: '/posts/edit', name: 'Edit Article', component: EditArticle },
  { path: '/posts/add-new', name: 'Create Article', component: AddNew },
  { path: '/posts/preview', name: 'Article Preview', component: Preview },
